    ...
    <div class="success-container anim-fade-in">
      <div class="u-glass u-rounded-3xl u-p-8 u-space-y-6 max-w-lg u-w-full">
        ...
        <div class="u-flex u-items-center u-justify-center u-gap-3 u-p-4 u-rounded-xl bg-secondary-50">
          <div class="w-10 h-10 u-rounded-2xl bg-gradient-to-br from-primary-20 to-accent-20 u-flex u-items-center u-justify-center " style="background: linear-gradient(135deg, #1f3d2b 0%, #2f4f3a 40%, #5a4a2a 70%, #7a4b1f 100%);">
