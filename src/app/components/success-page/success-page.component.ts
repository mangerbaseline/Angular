  ...
  template: `
    <div class="success-container anim-fade-in">
      <div class="u-glass u-rounded-3xl u-p-8 u-space-y-6 max-w-lg u-w-full">
        ...
        <div class="u-flex u-items-center u-justify-center gap-3 p-4 rounded-xl bg-secondary-50">
          <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-primary-20 to-accent-20 u-flex u-items-center u-justify-center">
          ...
          <div class="text-left"><p class="text-sm text-muted-foreground">Paid to</p><p class="u-font-semibold text-foreground">TechStore Pro</p></div>
        </div>
        <div class="u-space-y-4">
          <div class="border-t border-border-50 pt-4">
            <h2 class="text-sm font-medium text-muted-foreground mb-3 u-flex u-items-center gap-2">
            ...
            <div class="u-space-y-3 text-sm">
              ...
              <div class="u-flex u-justify-between"><span class="text-muted-foreground">Status</span><span class="status-primary font-medium u-flex u-items-center gap-1"><div class="w-2 h-2 rounded-full bg-primary animate-pulse"></div>Completed</span></div>
            </div>
          </div>
          <div class="border-t border-border-50 pt-4">
        ...
        <div class="u-space-y-3 pt-2">
          <button (click)="onReturn()" class="return-btn u-relative u-w-full py-4 px-6 rounded-xl u-flex u-items-center u-justify-center gap-3 transition-all duration-300 overflow-hidden bg-gradient-to-r from-primary to-emerald-400 text-primary-foreground u-font-semibold shadow-lg shadow-primary-25 hover:shadow-xl hover:shadow-primary-30" tabindex="0"><div class="shine-effect"></div><span class="u-relative u-flex u-items-center gap-2">Return to TechStore Pro<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-external-link w-5 h-5"><path d="M15 3h6v6"></path><path d="M10 14 21 3"></path><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path></svg></span></button>
          <div class="grid grid-cols-3 gap-3">
            <button class="action-btn u-flex u-flex-col u-items-center gap-2 p-4 rounded-xl bg-secondary-50 hover-bg-secondary transition-colors" tabindex="0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-download w-5 h-5 text-primary"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" x2="12" y1="15" y2="3"></line></svg><span class="text-xs text-muted-foreground">Receipt</span></button>
